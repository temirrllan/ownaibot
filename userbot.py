...
ИНТЕРЕСНО (отбирать):
- Искусственный интеллект и ML: новые модели, LLM, нейросети, AI-инструменты,
  AI-агенты, промпт-инжиниринг, исследования и крупные новости в области AI.
- Claude и его экосистема: Claude Code, Claude skills, Anthropic, MCP,
  возможности и обновления Claude, гайды и приёмы работы с ним.
...
- Мемы, развлекательный оффтоп, гороскопы, новости не по теме (политика,
  спорт, шоу-бизнес), если они не касаются IT/AI.
